...
function AccountBtnBtmNav({ profilePhoto }) {
  return (
    <>
      <Link to={"/account"} className="">
        <img
          src={profilePhoto}
          alt={profilePhoto}
          className="avatar h-5 rounded-full border-2 border-primary"
        />
  ...
  return (
    <>
      <div className="btm-nav bg-base-100 sm:hidden">
        ...
        {isLoggedIn ? (
          <AccountBtnBtmNav profilePhoto={user.profilePhoto}></AccountBtnBtmNav>
        ) : (
          <LoginBtnBtmNav></LoginBtnBtmNav>
        )}
      </div>
    </>
  );
